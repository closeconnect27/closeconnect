...
export function CommunityFilterBar() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="scrollbar-none flex gap-1 overflow-x-auto border-b border-border px-5">
        <button
      ...
      <div className="flex gap-2 px-5">
        <select
          ...
          className="rounded-full border border-border2 bg-bg3 px-3 py-1.5 text-xs text-text2"
        >
