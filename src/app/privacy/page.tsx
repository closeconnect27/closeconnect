    ...
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-6 flex flex-col gap-6 text-[15px] leading-relaxed text-text">
        <p>
          ...
          &quot;Service&quot;), a hyperlocal platform for discovering local events, forming groups, and accessing group-based
          discounts. This Privacy Policy explains how we collect, use, and protect your information when you use our Service.
        </p>
        ...
        <Section title="1. Information We Collect">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>Location (city/neighborhood) to show relevant local events and deals</li>
            <li>
              Payment information when you make a purchase (processed securely by our payment partner; we do not store your
              card or bank details)
            </li>
            <li>Content you post, such as group messages, event RSVPs, or reviews</li>
          </ul>
          ...
          <ul className="list-disc pl-5">
            ...
            <li>Approximate location (if you grant location permission), to personalize nearby event and deal recommendations</li>
          </ul>
        </Section>
        ...
        <Section title="2. How We Use Your Information">
          ...
          <ul className="list-disc pl-5">
            <li>Show you relevant local events, deals, and groups near you</li>
            <li>Process payments for event registrations and group purchases</li>
            <li>Facilitate group formation and communication between users</li>
            <li>Send you notifications about events, deals, or group activity you&apos;ve opted into</li>
        ...
        <Section title="3. How We Share Your Information">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>With local businesses/event organizers you interact with, limited to what&apos;s needed to fulfill your booking or group deal</li>
